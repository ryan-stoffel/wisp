...
mod tests {
    ...
    fn large_integers_are_numbers_and_fallback_variants_are_left_out() {
        ...
        assert!(generated.contains("export type ErrorKind = \"notInitialized\" | \"incompatibleProtocol\" | \"resyncRequired\" | \"projectNotFound\" | \"accountNotFound\" | \"keychainUnavailable\" | \"idConflict\" | \"contextNotFound\" | \"contextTooLarge\";"));
        assert!(
            generated.contains(
