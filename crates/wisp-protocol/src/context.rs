...
mod tests {
    ...
    use super::{ContextFile, ContextWriteId, ContextWriteParams};
    use crate::ProjectId;

    #[test]
    fn last_writer_and_writer_are_omitted_when_absent() {
        ...
        assert_eq!(
            value,
            json!({"path": "notes.md", "size": 3, "modifiedAt": "2026-09-24T12:00:00Z"})
        );

        let params = ContextWriteParams {
