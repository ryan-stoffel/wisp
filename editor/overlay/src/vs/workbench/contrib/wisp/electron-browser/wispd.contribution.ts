...
// The wispd connection in any window: the service, its context keys, and its commands. The
// editor window's wisp.contribution.ts and the Agents window's wisp entry both import it.
